...
(function () {
    ...
    // =========================================================================
    // 1. DYNAMIC & MOVABLE INTERACTIVE BACKGROUND CANVAS
    // =========================================================================
    ...
    if (canvas) {
        ...
        class Particle {
            ...
            init(randomY = false) {
                ...
                this.size = (1.2 + Math.random() * 2.2) * this.depth;
                this.baseSize = this.size;

                // Smooth drifting velocities
                this.vx = (Math.random() - 0.5) * 0.6 * this.depth;
                this.vy = -(0.2 + Math.random() * 0.5) * this.depth;
            ...
            update() {
                ...
                // Interactive Mouse Gravitational & Repulsion Physics
                if (mouse.isActive) {
                    ...
                    if (dist < mouse.radius && dist > 0) {
                        ...
                        const pushStrength = force * 6.5 * this.depth;
                ...
                for (let i = 0; i < shockwaves.length; i++) {
                    ...
                    if (waveDistDiff < 25) {
                        const waveForce = (1 - sw.radius / sw.maxRadius) * 4;
                ...
                // Apply and damp elastic displacements
                this.x += this.dx;
                this.y += this.dy;
                this.dx *= 0.88;
                this.dy *= 0.88;
        ...
        class TechShape {
            ...
            init() {
                ...
                this.sides = Math.random() > 0.5 ? 3 : 6; // Triangle or Hexagon
                this.color = colorPalette[Math.floor(Math.random() * colorPalette.length)];
            ...
            update() {
                ...
                if (mouse.isActive) {
                    ...
                    this.x += (dx - this.vx * 0.5) * 0.05;
                    this.y += (dy - this.vy * 0.5) * 0.05;
                }
        ...
        class Shockwave {
            ...
            update() {
                ...
                this.alpha = 0.6 * (1 - this.radius / this.maxRadius);
            }
        ...
        // Draw connective dynamic neural energy filaments
        function drawConnectiveWeb() {
            ...
            for (let i = 0; i < particles.length; i++) {
                ...
                // Connect nearby particles to mouse cursor for interactive web
                if (mouse.isActive) {
                    const distToMouse = Math.hypot(p1.x - mouse.x, p1.y - mouse.y);
                    if (distToMouse < mouseMaxDist) {
                        const alpha = (1 - distToMouse / mouseMaxDist) * 0.35;
                        ctx.beginPath();
                        ctx.moveTo(p1.x, p1.y);
        ...
        // Main animation loop (60 FPS fluid hardware accelerated)
        function animate() {
            ctx.clearRect(0, 0, width, height);

            // Smooth mouse interpolation for silky movement
            mouse.x += (mouse.targetX - mouse.x) * 0.12;
            mouse.y += (mouse.targetY - mouse.y) * 0.12;

            // Update & draw background geometric shapes
            for (let i = 0; i < techShapes.length; i++) {
                techShapes[i].update();
                techShapes[i].draw();
            }

            // Draw connective filaments
            drawConnectiveWeb();
        ...
        // Event Listeners for Dynamic Mouse & Touch
        ...
        window.addEventListener('mousemove', (e) => {
            ...
            // Update CSS variables for reactive cyber grid spotlight
        ...
        window.addEventListener('pointerdown', (e) => {
            // Trigger ripple unless clicking interactive buttons/inputs
    ...
    // =========================================================================
    // 2. DYNAMIC MOVABLE SPOTLIGHT GLOW (SMOOTH LERP FOLLOW)
    // =========================================================================
